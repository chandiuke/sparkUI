...
export function Chip({
  ...
  const baseStyles = clsx(
    ...
    isSelected && selectedStyles[color],
    isClickable && "cursor-pointer transition-all duration-200 hover:scale-105 active:scale-95",
    isClickable && !isDisabled && "focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1",
    className
  );

  const content = (
    <>
      {isSelected && !avatar && !startContent && variant !== "dot" && (
